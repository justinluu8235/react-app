    ...
    render(){
        return(
                        ...
                        <div id="navbarMenu" className="navbar-menu">
                            <div className="navbar-end">
                                <div className="tabs is-right">
                                    <ul>
                                        <li className="is-active" title="homeLink"><a>Home</a></li>
                                        <li title="exampleLink"><a href="">Examples</a></li>
                                        <li title="featuresLink"><a href="">Features</a></li>
                                        <li title="teamLink"><a href="">Team</a></li>
                                        <li><a href="">Help</a></li>
                                    </ul>
            ...
            <div className="hero-body">
                <div className="container has-text-centered">
                    <h1 className="title" title="main-display">
        ...
        <section className="container">
            ...
            <div className="intro column is-8 is-offset-2">
                <h2 className="title" title="middleBand">Perfect for developers or designers!</h2><br/>
                ...
                <div className="tile is-ancestor">
                    <div className="tile is-parent is-shady">
                        <article className="tile is-child notification is-white">
                            <p className="title" title="firstBox">Hello World</p>
                    ...
                    <div className="tile is-vertical is-8">
                        <div className="tile">
                            ...
                            <div className="tile is-parent">
                                <article className="tile is-child notification is-white">
                                    <p className="title" title="adBox">Middle box</p>
                ...
                <div className="columns">
                    <div className="column is-3 is-offset-2">
                        ...
                        <ul>
                            ...
                            <li title="murphyLaw"><a href="#">Murphy's law</a></li>
                    ...
                    <div className="control level-item">
                        <a href="https://github.com/BulmaTemplates/bulma-templates">
                            <div className="tags has-addons">
                                ...
                                <span className="tag is-info" title="mitLicense">MIT license</span>
                            </div>
                        </a>
                    </div>
                </div>
